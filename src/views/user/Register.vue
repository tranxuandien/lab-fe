<template>
    <Vueform size="md" :display-errors="false">
        ...
        <SelectElement name="country" :search="true" :native="false" input-type="search" autocomplete="disabled"
            placeholder="Country" items="/json/countries.json" />
        ...
        <PhoneElement name="phone" placeholder="Phone" :rules="[
            'required',
        ...
        <CheckboxElement name="terms" text="I accept the Terms & Conditions & Privacy Policy" />
        <CheckboxElement name="marketing_emails" text="I want to recieve marketing emails" />
